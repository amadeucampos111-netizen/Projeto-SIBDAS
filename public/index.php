        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Gestão de Equipamentos</h5></a>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Localização</h5></a>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Fornecedores</h5></a>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Documentação</h5></a>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Pesquisa Avançada</h5></a>
            ...
            <div class="col-md-4">
                <div class="card p-4 shadow-sm h-100 feature-card">
                    ...
                    <a href="login.html"><h5>Dashboard</h5></a>
    ...
    <div class="container">
        ...
        <div id="carouselEquipamentos" class="carousel slide shadow mx-auto rounded overflow-hidden" data-bs-ride="carousel" style="max-width: 750px;">
            <div class="carousel-indicators">
                ...
                <button type="button" data-bs-target="#carouselEquipamentos" data-bs-slide-to="2" aria-label="Slide 3"></button>
                <button type="button" data-bs-target="#carouselEquipamentos" data-bs-slide-to="3" aria-label="Slide 4"></button>
            </div>
