...
// ==========================================
// Fazemos um JOIN com a tabela de equipamentos para mostrar um resumo claro ao utilizador
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmar_eliminar'])) {
    ...
    $sql_delete = "DELETE FROM garantias_contratos WHERE id = ?";
    ...
    if ($stmt_delete) {
        ...
        if (mysqli_stmt_execute($stmt_delete)) {
            $_SESSION['msg_sucesso'] = "O registo de garantia/contrato foi removido do sistema com sucesso.";
        } else {
            $_SESSION['msg_erro'] = "Erro técnico ao tentar apagar: " . mysqli_stmt_error($stmt_delete);
        }
        mysqli_stmt_close($stmt_delete);
    } else {
        $_SESSION['msg_erro'] = "Erro interno ao preparar a eliminação.";
    }
...
<head>
    <meta charset="UTF-8">
    <title>MedTrack | Confirmar Eliminação de Garantia</title>
        ...
        <div class="col-md-6">
            ...
            <div class="card shadow-sm border-0 rounded-3 text-center p-4">
                <div class="card-body">
                    ...
                    <h4 class="fw-bold text-dark mb-3">Eliminar Registo de Garantia?</h4>
                    
                    <p class="text-muted mb-4">
                        Tem a certeza que deseja remover este registo de cobertura? Esta operação irá desligar o histórico de garantia do respetivo equipamento técnico e é <strong>irreversível</strong>.
                    </p>
                    ...
                    <form action="eliminar_garantia.php" method="POST">
